  ...
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        {/* Decorative circles */}
        <div className="absolute top-10 left-10 w-56 h-56 rounded-full overflow-hidden shadow-strong border-8 border-white hidden lg:block">
          <img
        ...
        <div className="absolute bottom-10 left-40 w-36 h-36 rounded-full overflow-hidden shadow-medium border-4 border-white hidden xl:block">
          <img
