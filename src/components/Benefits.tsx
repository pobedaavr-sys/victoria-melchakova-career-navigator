  ...
  return (
    <section className="py-20 bg-light-lavender relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        {/* Decorative circles */}
        <div className="absolute top-20 right-10 w-48 h-48 rounded-full overflow-hidden shadow-strong border-8 border-white hidden lg:block">
          <img
        ...
        <div className="absolute bottom-20 right-40 w-32 h-32 rounded-full overflow-hidden shadow-medium border-4 border-white hidden xl:block">
          <img
